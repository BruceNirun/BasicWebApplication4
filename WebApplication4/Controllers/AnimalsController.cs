...
namespace WebApplication4.Controllers
{
    public class AnimalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AnimalId,Name,Type,Leg,Arm,Head,Eyes,Tail")] Animal animal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AnimalId,Name,Type,Leg,Arm,Head,Eyes,Tail")] Animal animal)
        {
